...
cObject_Torch::cObject_Torch()
{
	m_Mesh = LoadModel("Test/Torch.x");
	m_Texture = LoadTexture("Test/torch_static01.dds");
	m_Normal = LoadTexture("Test/torch_static01_nrm.dds");
	m_Specqural = LoadTexture("Test/torch_static01_spec.dds");
...
void cObject_Torch::Update()
{
}

void cObject_Torch::Render()
{
